...
export function AiAppsNavPanel() {
  ...
  return (
    <aside className="flex h-full w-[240px] shrink-0 flex-col border-r border-[#E5E7EB] bg-white dark:border-aura-border dark:bg-aura-sidebar">
      <div className="border-b border-[#E5E7EB] px-4 py-3 dark:border-[var(--aura-border-soft)]">
        <div className="flex items-center gap-2">
          <Sparkles className="h-4 w-4 text-[#6C5CE7]" />
          <h2 className="text-[14px] font-semibold text-aura-text">AI Apps</h2>
        </div>
      </div>
              ...
              <Link
                ...
                className={`flex items-center gap-2.5 rounded-lg px-2.5 py-2 text-[13px] font-medium transition ${
                  item.active && item.label === "Feed"
                    ...
                    : "text-[#4B5563] hover:bg-[#F9FAFB] dark:text-aura-gray dark:hover:bg-[var(--aura-row-hover)]"
                }`}
              >
        ...
        <div className="mt-4 px-1">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-[#E5E7EB] bg-[#F9FAFB] py-2 pl-8 pr-3 text-[12px] outline-none placeholder:text-aura-gray-2 focus:border-[#6C5CE7]/40 dark:border-aura-border dark:bg-[var(--aura-input-bg)]"
            />
          </div>
        </div>
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-2.5 rounded-lg px-2 py-2 text-[13px] transition ${
                      active
                        ...
                        : "font-medium text-[#4B5563] hover:bg-[#F9FAFB] dark:text-aura-gray"
                    }`}
                  >
                    <span
